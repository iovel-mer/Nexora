          ...
          <div className="prose prose-invert max-w-none">
            <div className="text-gray-300 leading-relaxed space-y-6">
              <div>
                ...
                <p className="mb-4">
                  By accessing and using Nexora, you accept and agree to be
              ...
              <div>
                ...
                <p className="mb-4">
                  Nexora provides cryptocurrency trading services. All
              ...
              <div>
                ...
                <p className="mb-4">
                  Nexora shall not be liable for any indirect, incidental,
