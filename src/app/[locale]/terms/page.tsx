...
export default function TermsOfService() {
  ...
  return (
    <>
      <Header />
      <main className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-orange-900 text-white px-6 py-20 relative flex items-center justify-center">
        {/* Background Grid */}
        ...
        <div className="relative z-10 max-w-5xl w-full bg-slate-900/60 backdrop-blur-xl border-2 border-orange-400/30 rounded-3xl shadow-2xl shadow-orange-500/20 p-8 sm:p-12">
          {/* Navigation link */}
          <div className="mb-8">
              <Link
                  href="/"
          ...
          {/* Title */}
          <h1 className="text-5xl font-black mb-10 bg-clip-text text-transparent bg-gradient-to-r from-white via-orange-200 to-amber-200 uppercase font-mono drop-shadow-[0_0_20px_rgba(251,146,60,0.3)]">
            {t("title")}
          </h1>
          ...
          <section className="space-y-10 text-sm sm:text-base leading-relaxed">
            {[...Array(8)].map((_, index) => (
              <div key={index} className="p-6 bg-slate-900/40 backdrop-blur-xl border border-orange-400/20 rounded-2xl hover:border-orange-400/40 transition-all duration-300 hover:shadow-lg hover:shadow-orange-500/20">
